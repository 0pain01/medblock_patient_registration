...
This project is a **React**-based application that allows users to register patients, query patient records using SQL, persist patient data across page refreshes, and supports multi-tab usage. 
The system utilizes **PGlite** (a lightweight SQLite client for the browser) to store patient data in an IndexedDB database.
